...
CREATE TABLE IF NOT EXISTS "SavingCategory" (
    id SERIAL PRIMARY KEY,
    name VARCHAR(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "SavingEntry" (
    ...
    "categoryId" INTEGER REFERENCES "SavingCategory"(id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS "SavingCategory_userId_idx" ON "SavingCategory" ("userId");
CREATE INDEX IF NOT EXISTS "SavingEntry_categoryId_idx" ON "SavingEntry" ("categoryId");
